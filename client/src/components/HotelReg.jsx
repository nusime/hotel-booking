...
const HotelReg = () => {
  ...
  const {setShowHotelReg, axios, getToken, setIsOwner, setHasHotel, navigate} = useAppContext();
        ...
        className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
          ...
          <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto'>
              ...
              w-full px-3 py-2 mt-1 outline-indigo-500 font-light' required>
            ...
            <button className='bg-[#54201c] hover:bg-[#49B9FF]/50 hover:text-black transition-all
