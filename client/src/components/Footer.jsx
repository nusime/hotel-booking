    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 pt-10'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Discover, book, and relax. EliteNest brings the best stays to your fingertips.
                    </p>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='flex items-center justify-center bg-[#54201c] h-9 w-9 aspect-square rounded-r'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} EliteNest . All rights reserved.</p>
