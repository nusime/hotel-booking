...
const HotelCard = ({room, index}) => {
  return (
    ...
    shadow-[0px_4px_4px_rgba(0,0,0,0.05)] '>
        <img src={room?.images?.[0] || '/roomImg4.png'} alt= ''
        className='w-full h-48 object-cover rounded-xl transition-transform duration-300 ease-in-out hover:scale-110 '/>
        ...
        <div className='p-4 pt-5'>
            ...
            <div className='flex items-center justify-between mt-4'>
                <p><span className='text-xl text-gray-800'>Birr{room.pricePerNight}</span>/night</p>
