...
const RoomDetails = () => {
    ...
    const checkAvailability = async (e) => {
        try {
            // Check is Checkin date is before checkout date   
  ...
  return room &&(
    ...
    <div className='py-24 md:py-40 px-4 md:px-16 lg:px-24 xl:px-32'>
        {/* Room Details */}
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl md:text-4xl font-playfair'>
                    Experience Luxury As Never Before.
                </h1>
        ...
        bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <button type='submit' className='bg-[#54201c] hover:bg-[#49B9FF]/50 active:scale-95
            transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-24 py-3
        ...
        <div>
            <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                ...
                You get a comfortable two bedroom apartment has atrue city feeling. The price
                quoted is for two guests, at the guest slot please mark number of guests to get
        ...
        <div className='flex flex-col items-start gap-4'>
            ...
            <button className='px-6 py-2.5 mt-4 rounded text-white bg-[#54201c] hover:bg-[#49B9FF]/50
